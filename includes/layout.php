    ...
    function astro_menu_rows()
    {
        return array(
            array(
                ...
                array('href' => '/skycoverus.php', 'label' => 'SkyCoverUS', 'disabled' => astro_feature_disabled('config/tgskyus.off')),
                array('href' => '/ndfd.php', 'label' => 'NDFD'),
                array('href' => '/cloud.php', 'label' => 'Cloud'),
                array('href' => '/goes.php', 'label' => 'GOES', 'disabled' => astro_feature_disabled('config/tggoes.off')),
