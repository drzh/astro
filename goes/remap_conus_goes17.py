...
# GOES-17 Extent for CONUS (satellite projection) [llx, lly, urx, ury]
GOES17_EXTENT = [-2505021.620665066, 1583173.7143861316, 2505021.620665066, 4589199.739172205]

# GOES-17 Spatial Reference System
sourcePrj = osr.SpatialReference()
sourcePrj.ImportFromProj4('+proj=geos +h=35786023.0 +a=6378137.0 +b=6356752.31414 +f=0.00335281068119356027 +lat_0=0.0 +lon_0=-137.0 +sweep=x +no_defs')
