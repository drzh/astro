...
# GOES-16 Extent for FullDisk (satellite projection) [llx, lly, urx, ury]
# GOES16_EXTENT = [-5434894.885056, -5434894.885056, 5434894.885056, 5434894.885056]
# GOES-16 Extent for CONUS (satellite projection) [llx, lly, urx, ury]
GOES16_EXTENT = [-3627271.3152550682, 1583173.7143861316, 1382771.9260750636, 4589199.7391722053]

# GOES-16 Spatial Reference System
sourcePrj = osr.SpatialReference()
sourcePrj.ImportFromProj4('+proj=geos +h=35786023.0 +a=6378137.0 +b=6356752.31414 +f=0.00335281068119356027 +lat_0=0.0 +lon_0=-75.0 +sweep=x +no_defs')
